        ...
        <form name="f1" action="cust_detail" method="post">
            <table cellpadding="7" align="center" border="1">
                ...
                <tr>
                    <td>Oil Change:</td>
                          ...
                          <td> <select name="carsi" id="cars">
                            <option value="null" onclick="carfun()"hidden>Select Oil Type</option>
                ...
                <tr>
                    <td for="cars">Car Cleaning:</td>
                          ...
                          <td> <select name="carcle" id="cars">
                            <option value="null" onclick="carfun()" hidden>Select Cleaning Type</option>
                ...
                <tr>
                    <td for="cars">Tyers & Wheel Change:</td>
                          ...
                          <td> <select name="wheeltyp" id="cars">
                            <option value="null" onclick="carfun()"hidden>Select Wheels Type</option>
                ...
                <tr>
                    ...
                    <td><input type="text" name="qty" value="0" onkeyup="carfun()" class="put"></td>
                </tr>
                <tr>
                    <td>Wheel price</td>
